...
class config {
 public:
  ...
  bool record_masterLog = false;
  bool rebuild_table = false;
  bool record_cur = true;

  //Things that break...//RAC

  bool break_on_update = false;
  bool break_on_insert = false;
  bool break_on_select = false;

  int break_on_at = -1;
  bool break_macro = false;
  bool break_micro = false;

  int macro_break_type = 0;
  /*
    Break type 1 = between record ptr creation and statement exec
  */
